...
< 10130405 >
透過画像で感情を表示する(怒ってる奴だけ)の場合
たくみの一覧はそのままのやつ

課題：
	たくみが作ってくれている一覧のようなものの順番を変更させること

次：
	透過画像にする処理の順番が大切だから、
	順番を変えなくてもいいような関数を表情別で作れると良い
	addweited()を消すこと。消したやつと消してないやつある方がみやすいから（多分）

コメント：
	記録は残していない
	表情全部書き直すか悩む
	発表にまにあわない場合、全部を長ったらしく書き直す
	理想は表情別に関数を作ること
	face_sut_user_reはそれで一つの関数を使いまわしにできるとよい
	画像貼り付け関数を見直すこと（名前の変更とか、分かりにくい）
	とにかく疲れたもう4時まわっててきつい
